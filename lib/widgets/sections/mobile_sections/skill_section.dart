...
class SkillsSection extends StatelessWidget {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            MediaQuery.of(context).size.width > 515 ? Padding(
            ...
            Center(
              child: Wrap(
                ...
                runSpacing: 20.0,
                children: [
                  buildProjectBlock(context,'assets/fl.png', 'Flutter', 'An open source framework by Google for building apps'),
                  buildProjectBlock(context,'assets/firebase.jpg', 'Firebase', 'Platforms for backend cloud services by Google'),
                  buildProjectBlock(context,'assets/c.jpg', 'C/C++ and Iot', 'Gives you super-powers'),
                ],
              ),
            ),
          ],
  ...
  Widget buildProjectBlock(BuildContext context,String imagePath, String title ,String description){
