...
class PcInterestSection extends StatefulWidget {
  const PcInterestSection({super.key});

  @override
  State<PcInterestSection> createState() => _PcInterestSectionState();
}

class _PcInterestSectionState extends State<PcInterestSection> {
  @override
      ...
      children: [
        ...
        Align(
          ...
          child: Padding(                                                              // 1st Row of project blocks
            ...
            child: Wrap(
              children: <Widget>[
                makeEntityBlock('Flame', "assets/flame.jpg", "2D game engine built on top of Flutter"),
